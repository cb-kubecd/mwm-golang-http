  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
          ...
          dir('/home/jenkins/go/src/github.com/cb-kubecd/mwm-golang-http/charts/preview') {
            sh "make preview"
    ...
    stage('Promote to Environments') {
      ...
      steps {
          dir('/home/jenkins/go/src/github.com/cb-kubecd/mwm-golang-http/charts/mwm-golang-http') {
            ...
            sh "jx promote -b --all-auto --timeout 10m --version \$(cat ../../VERSION)"
          }
      }
    }
  }
